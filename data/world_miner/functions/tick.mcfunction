...
execute as @e[tag=custom_ai.world_miner.bot] unless block ~ ~-1 ~ minecraft:bedrock run tag @s add custom_ai.world_miner.events.is_mining
execute as @e[tag=custom_ai.world_miner.bot,tag=custom_ai.world_miner.events.is_mining] at @s run setblock ~-3 ~-1 ~-3 minecraft:air
